...
<body>
	...
	<div class="main-title">
		<h2><?php echo ($meta_title); ?>(<?php echo ($_total); ?>)</h2>
	</div>
	<!-- 按钮工具栏 -->
	<div class="cf">
		<div class="fl">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入线路标题">
				<a class="sch-btn" href="javascript:void(0);" id="search" url="<?php echo U('index', array('site_id'=>$site_id), false);?>"><i class="btn-search"></i></a>
			</div>
		</div>
	</div>
    ...
    <div class="data-table">
		<table>
            ...
            <!-- 列表 -->
            <tbody>
                <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
						<td><input class="ids" type="checkbox" name="line_id[]" value="<?php echo ($val['line_id']); ?>" /></td>
						<td><?php echo ($val['title']); ?> </td>
						<td><?php echo ($val['view_num']); ?></td>
						<td><?php echo (get_line_type($val['l_type'])); ?></td>
						<td><?php echo (get_can_tuan($val['ct_type'])); ?></td>
						<td><span><?php echo (time_format($val['update_time'])); ?></span></td>
						<td><span><?php echo ($val['order_num']); ?></span></td>
						<td>
