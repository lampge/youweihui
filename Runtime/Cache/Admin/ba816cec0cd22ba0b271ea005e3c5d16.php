...
<body>
			...
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						...
						<div class="controls">
							<select name="display">
								<option value="1" <?php if(($info["display"]) == "1"): ?>selected="selected"<?php endif; ?>>显示</option>
								<option value="0" <?php if(($info["display"]) == "0"): ?>selected="selected"<?php endif; ?>>隐藏</option>
							</select>
						</div>
					</div>
					<div class="form-item">
	...
	<script type="text/javascript">
		<?php if(isset($info["id"])): ?>Think.setValue("display", <?php echo ((isset($info["display"]) && ($info["display"] !== ""))?($info["display"]):1); ?>);<?php endif; ?>
		$(function(){
			showTab();
		...
		//导航高亮
		highlight_subnav('<?php echo U(CONTROLLER_NAME . '/index');?>');
	</script>
